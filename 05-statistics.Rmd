...
data_comb <- rbind(data, data_highschool, data_university) %>%
  mutate(group = factor(rep(c("Primary School", "High School", "University"), each = 10),
                        levels = c("Primary School", "High School", "University"), ordered = TRUE)) %>%
  select(names, group, scores)
```
